...
//        dd($request);
        ...
        if (empty($request)) {
            ...
            $animal = $animal->leftJoin('types','types.id','=','races.id_type_fk')->addSelect('races.id as races_id', 'races.label as races_label');
